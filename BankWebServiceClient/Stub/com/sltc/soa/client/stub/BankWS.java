 ...
 * 
 */
@WebService(name = "BankWS", targetNamespace = "http://soa.sltc.com/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface BankWS {
    ...
    @Action(input = "http://soa.sltc.com/BankWS/transferRequest", output = "http://soa.sltc.com/BankWS/transferResponse")
    ...
    @Action(input = "http://soa.sltc.com/BankWS/addUserRequest", output = "http://soa.sltc.com/BankWS/addUserResponse")
    ...
    @Action(input = "http://soa.sltc.com/BankWS/depositRequest", output = "http://soa.sltc.com/BankWS/depositResponse")
    ...
    @Action(input = "http://soa.sltc.com/BankWS/withdrawRequest", output = "http://soa.sltc.com/BankWS/withdrawResponse")
